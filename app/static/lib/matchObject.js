   ...
   mo.common = () => {
      ...
      let pub = {
         ...
         addStatPoint(episode) {
            ...
            if (point.result == 'Winner') addStat(point.server, episode, 'winners');
            if (point.result == 'Unforced Error') addStat(point.server, episode, 'unforcedErrors');
            if (point.result == 'Forced Error') addStat(point.server, episode, 'ForcedErrors');
