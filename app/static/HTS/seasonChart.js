// roundN
// yrdate -- don't convert to 2016 in calling module
    ...
    var options = {
        ...
        plot: {
           ...
           shape: {
              ...
              circleSizeBase: undefined, // divisor for value given by sizeKey attribute
        ...
        selection.each(function () {
            ...
            update = function(opts) {
               ...
               if (!options.data.calculateDomain) {
                  ...
                  var dateDomain = d3.extent(data.values.map(function(m) { return m.yrdate; }));
               ...
               var plot_width  = options.width  - (options.margins.left + options.margins.right);
               var plot_height = options.height - (options.margins.top + options.margins.bottom);
               ...
               var axisY = d3.svg.axis()
                   ...
                   .tickFormat(function(d, i) { return roundScale(d); })
                   .scale(yScale);
               ...
               footnote
                  ...
                  .html(function() { if (options.display.source) return 'Source: ' + options.display.source; })
                  .attr({
                     'class': 'footnote',
                     'x':     function() {
               ...
               title
                  ...
                  .html(function(d) { 
                     return data.values[0].name + " " + data.yr; 
                  });

               var line = d3.svg.line()
                  .interpolate("step-before")
                  .x(function(d, i) { return xScale(d.yrdate); })
                  .y(function(d, i) { return yScale(d.roundN); });
               ...
               item_shapes.enter().append(shape ? 'path' : 'circle')
                  .translate(function(d, i) { return [xScale(d.yrdate), 0]; })
                  .style({
                    'opacity':      0,
                    'fill-opacity': 0,
                    'stroke':       shapeColor,
               ...
               item_shapes
                  ...
                  .transition().duration(options.display.transition_time)
                  .translate(function(d, i) { return [xScale(d.yrdate), yScale(d.roundN)]; })
                  .attr({
                    fill:  shapeColor,
               ...
               function circleRadius(d) {
                  ...
                  var sizeBase = options.plot.shape.circleSizeBase;
