module.exports = function(models) {
   ...
   api_router.route('/player/bio/:player')
       .get(cors(), function(req, res) {
           Player.find(
              {
   ...
   api_router.route('/codes/:tuid/:puid/:year')
       .get(cors(), function(req, res) {
           Match.find(
              {
                 $and: [
              ...
              {
                 _id: 0, muid: 1, "codes": 1, "opts": 1, "metadata": 1
              }, 
              function(err, array) {
                 if (err)
                     return res.send(err);
   ...
   api_router.route('/matches/stats/puid/:puid')
       .get(cors(), function(req, res) {
           Match.find(
              {
              ...
              }, 
              {
                 ...
                 _id: 0, muid: 1, "stats": 1, "metadata.players.name": 1
              }, 
              function(err, array) {
                 if (err)
                     return res.send(err);
                 if (array == null) {
                    ...
                    var result = array.filter(function(f) { return f.stats.length; });
                    return res.json(result);
                 }
           });
       });

   api_router.route('/matches/stats/player/:player')
       .get(cors(), function(req, res) {
           Match.find(
              {
   ...
   api_router.route('/matches/:player')
       .get(cors(), function(req, res) {
           Match.find(
              {
                 "metadata.players": { $elemMatch: { "name": req.params.player } } 
              ...
              {
                 _id: 0, "muid": 1, "score": 1, "opts": 1, "metadata": 1, "sources": 1
              }, 
              function(err, array) {
                 if (err)
                     return res.send(err);
   ...
   api_router.route('/matches/codes/:player')
       .get(cors(), function(req, res) {
           Match.find(
              {
                 "metadata.players": { $elemMatch: { "name": req.params.player } } 
              ...
              {
                 _id: 0, muid: 1, "score": 1, "codes": 1, "opts": 1, "metadata": 1, "sources": 1
              }, 
              function(err, array) {
                 if (err)
                     return res.send(err);
   ...
   api_router.route('/matches/codes/limit/:player/:limit')
       .get(cors(), function(req, res) {
           Match.find(
              {
                 "metadata.players": { $elemMatch: { "name": req.params.player } } 
           ...
           }).limit(parseInt(req.params.limit)).sort({"metadata.match.date": -1});
       });

   api_router.route('/matches/codes/:player/:year')
       .get(cors(), function(req, res) {
           Match.find(
              {
   ...
   api_router.route('/matches/stats/org/:org')
       ...
       .get(cors(), function(req, res) {
           OldMatch.find(
              ...
              {
                 _id: 0, date: 1, players: 1, stats: 1
              }, 
              function(err, array) {
                 if (err)
                     return res.send(err);
   ...
   api_router.route('/matches/stats/org/:org/:year')
   ...
   api_router.route('/match/muid/:muid')
   ...
   */
   ...
   api_router.route('/player/stats/overview/:player')
       ...
       .get(cors(), function(req, res) {
           Match.find(
              ...
              {
                 _id: 0, players: 1, "stats.overview": 1, muid: 1, date: 1
              }, 
              function(err, array) {
                 if (err)
                     return res.send(err);
   ...
   api_router.route('/player/stats/overview/:player/:year')
   ...
   */
   ...
   api_router.route('/match/share')
      .post(function(req,res){
         if (req.body.action) {
            switch (req.body.action) {
               case "save":
                  let save = true;
                  if (!req.body.destination || typeof req.body.destination != 'string') save = false;
                  if (!req.body.filename || typeof req.body.filename != 'string') save = false;
                  if (!req.body.filetype || typeof req.body.filetype != 'string') save = false;
                  ...
                  if (save) {
                     ...
                     fs.writeFile(file_to_write, JSON.stringify(req.body.data), 'utf8', function(err) {
                        if (!err) {
               ...
               case "save":
                  ...
                  if (req.body.destination) {
                     ...
                     if (destinations.indexOf(destination) >=  0) {
                        fs.writeFile('./cache/_' + destination + '/' + filename + '.json', JSON.stringify(req.body.data), 'utf8', function(err) {
                           if (!err) {
   ...
   api_router.route('/match/request')
      .post(function(req,res){ 
         if (req.body.tournament) {
            ...
            if (['hts', 'te', 'atp'].indexOf(tour >= 0)) {
               ...
               fs.readFile(dir + req.body.tournament + '.json', 'utf8', function(err, data) {
                 if (!err) {
            ...
            fs.readFile('./cache/atp/draws/atp-' + req.body.atp + '.json', 'utf8', function(err, data) {
              if (!err) {
                 return res.json( { data: data } );
              } else {
                 return res.json( { err: err } );
            ...
            fs.readFile('./cache/_tenniseurope/juniors/te-' + req.body.te + '.json', 'utf8', function(err, data) {
              if (!err) {
                 return res.json( { data: data } );
              } else {
                 return res.json( { err: err } );
            ...
            fs.readFile('./app/static' + req.body.matchURL, 'utf8', function(err, data) {
              if (!err) {
                 return res.json( { data: data } );
              } else {
                 return res.json( { err: err } );
